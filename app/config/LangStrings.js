  ...
  constructor() {
    ...
    this.strings = {
      en: {
        ...
        downloadDialog: 'Additional information about the key must be downloaded before you can use it',
        betaKeys: 'Beta keys',
      ...
      no: {
        ...
        downloadDialog: 'Du må laste ned nøkkelen før du kan begynne å bruke den',
