  ...
  constructor() {
    ...
    this.strings = {
      en: {
        ...
        downloadDialog: 'The key will now be downloaded. This should not take more than a minute. Select the downloaded key again to start using it.',
      ...
      no: {
        ...
        downloadDialog: 'Nøkkelen vil nå bli lastet ned. Dette burde ikke ta mer enn et minutt. Deretter velger du den nedlastede nøkkelen på nytt i nøkkellisten for å begynne artsidentifisering.',
