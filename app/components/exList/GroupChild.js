...
class GroupChild extends React.PureComponent {
  /**
   * state:
  ...
  componentWillReceiveProps(nextProps) {
    if (
      !this.arraysIdentical(this.props.spValues, nextProps.spValues) &&
      !nextProps.speciesLeftLoading
    ) {
      this.setState({
        isActive: nextProps.spValues.indexOf(nextProps.id) !== -1
      });
    }
  }
  ...
  render() {
    return (
      <TouchableHighlight
        ...
        underlayColor={
          this.state.isActive ? "#dedede" : "rgba(255, 255, 255, 0)"
        }
        onLongPress={this.longclick}
      >
        <Row
          style={{
            height: this.props.deviceTypeAndroidTablet ? 110 : 60,
            alignItems: "center"
          }}
        >
          <Image
              ...
              this.props.disabled
                ? {
                    ...
                    width:
                      ...
                      (this.props.deviceTypeAndroidTablet ? 180 : 130)
                  }
                : {
                    fontSize: this.props.deviceTypeAndroidTablet ? 30 : 15,
                    marginRight: 10,
          ...
          {this.state.isActive ||
            (this.props.chosenValues.length !== 0 && !this.props.selected && (
              <Icon
                style={{
