...
class KeyListElement extends React.PureComponent {
  /**
  ...
  componentWillReceiveProps(newprops) {
    if (newprops.downloaded !== this.state.downloadedVisible) {
      this.setState({
        downloadedVisible: newprops.downloaded === 0 ? false : true
      });
    }
  }
      ...
      >
        <View style={styles.container}>
          <Image
            source={
              Platform.OS === "ios"
                ? { uri: ImageConfig.getkeyThumbs(this.props.id) }
                : { uri: "file://" + ImageConfig.getkeyThumbs(this.props.id) }
            }
            style={
              this.props.deviceTypeAndroidTablet
                ? stylesAndroidTablet.image
                : styles.image
            }
          >
            {this.state.downloadedVisible === false ? (
              <Icon
          ...
          <View style={styles.textCont}>
            ...
            {this.props.level && (
              <Text
                style={
                  this.props.deviceTypeAndroidTablet
                    ? stylesAndroidTablet.text2
                    : styles.text2
                }
              >
                {this.props.strings.level + this.props.level}
              </Text>
            )}
            {this.props.keyAuthor && (
              <Text
                style={
                  this.props.deviceTypeAndroidTablet
                    ? stylesAndroidTablet.text2
              ...
              >
                {this.props.strings.author + this.props.keyAuthor}
              </Text>
            )}
          </View>
          <View>
